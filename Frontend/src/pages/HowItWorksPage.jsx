			...
			<div className="pt-20 pb-16">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
					<div className="text-center">
						<h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6" style={{ color: '#1C3F94' }}>
						...
						<div className="flex flex-col md:flex-row items-center gap-8">
							<Card className="w-full md:w-1/2 text-left border-0 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 relative overflow-visible bg-white group" style={{ borderRadius: '20px' }}>
								...
								<CardHeader className="relative z-10 pb-4 pt-6">
									<div className="w-20 h-20 rounded-full flex items-center justify-center mb-4 shadow-2xl group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: '#1C3F94' }}>
							...
							<div className="w-full md:w-1/2 flex justify-center md:justify-end">
								<div className="w-64 h-64 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center opacity-50">
									<Camera className="w-32 h-32 text-blue-400" />
								</div>
							</div>
						</div>
