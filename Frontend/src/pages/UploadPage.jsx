...
export default function UploadPage() {
	...
	return (
		<div className="min-h-screen bg-gray-50">
			<Navbar />
			<div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 pb-6 sm:pb-8">
				<div className="text-center mb-6 sm:mb-8">
					<h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">{t('upload.title')}</h1>
					<p className="text-sm sm:text-base md:text-lg text-gray-600">{t('upload.subtitle')}</p>
				</div>
