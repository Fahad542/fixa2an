...
export default function WorkshopSignupPage() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-[#1C3F94]/5 via-white to-[#34C759]/5 relative overflow-hidden">
			...
			<Navbar />
			<div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-16 sm:pt-20 pb-6 sm:pb-8 relative z-10">
				<div className="text-center mb-8 sm:mb-10 mt-4 sm:mt-8 animate-fade-in-up">
				...
				<form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
					...
					<Card className="shadow-xl border border-gray-200/50 bg-white/95 backdrop-blur-sm">
						<CardHeader className="pb-3 sm:pb-4 bg-gradient-to-r from-[#1C3F94]/10 to-[#34C759]/10 rounded-t-lg border-b border-gray-200/50 mb-4">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
								...
								<div>
									...
									<Input
										...
										className={`px-4 py-3 rounded-xl border-2 transition-all bg-gray-50/50 hover:bg-white ${fieldErrors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-200 focus:ring-2 focus:ring-[#1C3F94] focus:border-[#1C3F94]'}`}
									/>
									{fieldErrors.email && (
					...
					<Card className="shadow-xl border border-gray-200/50 bg-white/95 backdrop-blur-sm">
						<CardHeader className="pb-3 sm:pb-4 bg-gradient-to-r from-[#1C3F94]/10 to-[#34C759]/10 rounded-t-lg border-b border-gray-200/50 mb-4">
							<CardTitle className="flex items-center gap-2 text-base sm:text-lg text-gray-900">
								<Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1C3F94]" />
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
								...
								<div>
									...
									<Input
										...
										className={`px-4 py-3 rounded-xl border-2 transition-all bg-gray-50/50 hover:bg-white ${fieldErrors.organizationNumber ? 'border-red-500 focus:ring-red-500' : 'border-gray-200 focus:ring-2 focus:ring-[#1C3F94] focus:border-[#1C3F94]'}`}
									/>
					...
					<Card className="shadow-xl border border-gray-200/50 bg-white/95 backdrop-blur-sm">
						<CardHeader className="pb-3 sm:pb-4 bg-gradient-to-r from-[#1C3F94]/10 to-[#34C759]/10 rounded-t-lg border-b border-gray-200/50 mb-4">
							<CardTitle className="flex items-center gap-2 text-base sm:text-lg text-gray-900">
								<Clock className="w-4 h-4 sm:w-5 sm:h-5 text-[#1C3F94]" />
						...
						<CardContent className="px-4 sm:px-6">
							<div className="space-y-4">
								{['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(
									(day) => (
										<div key={day} className="flex items-center gap-4 p-3 bg-gray-50/50 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors">
											<Label className="capitalize text-sm sm:text-base font-semibold text-gray-700 min-w-[100px] sm:min-w-[120px]">
							...
							<div className="space-y-2">
								...
								<div className="relative">
									<select
										...
										className="w-full h-12 rounded-xl border-2 border-gray-200 bg-gray-50/50 px-4 py-3 pr-10 text-sm ring-offset-white focus:outline-none focus:ring-2 focus:ring-[#1C3F94] focus:border-[#1C3F94] hover:bg-white transition-all appearance-none cursor-pointer"
										defaultValue=""
									>
								...
								<div>
									...
									<div className="flex flex-wrap gap-2">
										{formData.brands.map((brand) => (
											<div
												key={brand}
												className="inline-flex items-center gap-2 px-4 py-2 bg-[#1C3F94]/10 text-[#1C3F94] rounded-full text-sm font-medium border border-[#1C3F94]/20 hover:bg-[#1C3F94]/20 transition-colors"
											>
												<span>{brand}</span>
												<button
													type="button"
													onClick={() => handleRemoveBrand(brand)}
													className="hover:bg-[#1C3F94]/30 rounded-full p-0.5 transition-colors"
						...
						<CardContent className="px-4 sm:px-6">
							<div
								...
								className={`border-2 border-dashed rounded-xl p-4 sm:p-6 md:p-8 text-center cursor-pointer transition-all ${
									isDragActive
										? 'border-[#1C3F94] bg-[#1C3F94]/10 shadow-lg scale-[1.02]'
										: 'border-gray-300 hover:border-[#1C3F94] hover:bg-[#1C3F94]/5 hover:shadow-md'
								}`}
							>
								<input {...getInputProps()} />
								<Upload className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 mx-auto mb-3 sm:mb-4 text-gray-400" />
								{isDragActive ? (
									<p className="text-sm sm:text-base md:text-lg text-[#1C3F94] font-semibold">
					...
					<div className="flex justify-end pt-4">
						<Button 
							type="submit" 
							size="default" 
							className="w-full sm:w-auto bg-gradient-to-r from-[#1C3F94] to-[#1C3F94]/90 hover:from-[#1C3F94]/90 hover:to-[#1C3F94] text-white font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] focus:ring-4 focus:ring-[#1C3F94]/30" 
				...
				<div className="text-center mt-6 sm:mt-8">
					<p className="text-xs sm:text-sm text-gray-600">
						...
						<Link to="/auth/signin" className="font-medium text-blue-600 hover:text-blue-800">
